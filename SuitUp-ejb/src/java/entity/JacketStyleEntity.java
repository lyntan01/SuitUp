 ...
 */
@Entity
public class JacketStyleEntity implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (jacketStyleId != null ? jacketStyleId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.jacketStyleId == null && other.jacketStyleId != null) || (this.jacketStyleId != null && !this.jacketStyleId.equals(other.jacketStyleId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "entity.JacketStyleEntity[ id=" + jacketStyleId + " ]";
    }
