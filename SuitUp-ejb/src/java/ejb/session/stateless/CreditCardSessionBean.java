...
//        try 
//        {
//            String cipherText = new String(cryptographicHelper.doAESEncryption(plainText, glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionKey(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionIv()), cryptographicHelper.getDEFAULT_CHARSET_NAME());
//            String recoveredPlainText = cryptographicHelper.doAESDecryption(cipherText, glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionKey(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionIv());
//            System.out.println("\nCipher Text: " + cipherText);
//            System.out.println("\nRecovered Plain Text: " + recoveredPlainText);
//        }
...
//        }
        if (constraintViolations.isEmpty()) {
            try {
                ...
                String encryptedCreditCardNumber = new String(cryptographicHelper.doAESEncryption(newCreditCardEntity.getCardNumber(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionKey(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionIv()), cryptographicHelper.getDEFAULT_CHARSET_NAME());
                String encryptedCVV = new String(cryptographicHelper.doAESEncryption(newCreditCardEntity.getCvv(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionKey(), glassFishCryptographicHelper.getGlassFishDefaultSymmetricEncryptionIv()), cryptographicHelper.getDEFAULT_CHARSET_NAME());

                newCreditCardEntity.setCardNumber(encryptedCreditCardNumber);
                newCreditCardEntity.setCvv(encryptedCVV);
//                newCreditCardEntity.setCardNumber(newCreditCardEntity.getCardNumber());
//                newCreditCardEntity.setCvv(newCreditCardEntity.getCvv());
...
//            } catch (PersistenceException ex) {
            } catch (PersistenceException | UnsupportedEncodingException ex) {
